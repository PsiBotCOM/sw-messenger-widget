...
function sw_page_settings() {
    ...
    <div class="wrap sw-admin">
        <h1>Social Widget — General Settings</h1>
        <form method="post">
            ...
            <div class="sw-card">
                ...
                <table class="form-table">
                    <tr><th>Enable plugin</th><td><label class="sw-toggle-label">
                        <input type="checkbox" name="enabled" value="1" <?php checked($g['enabled'],1); ?>>
                        <span class="sw-toggle-switch"></span>
                        <span class="sw-toggle-text">Show widget on site</span>
                    </label></td></tr>
                    <tr><th>Position</th><td>
                        <label><input type="radio" name="position" value="right" <?php checked($g['position'],'right'); ?>> Right</label> &nbsp;
                        <label><input type="radio" name="position" value="left"  <?php checked($g['position'],'left');  ?>> Left</label>
                    </td></tr>
                    <tr><th>Side offset (px)</th><td>
                        <input type="number" name="offset_side" value="<?php echo esc_attr($g['offset_side']); ?>" min="0" max="200" class="small-text"> px
                    </td></tr>
                    <tr><th>Bottom offset (px)</th><td>
            ...
            <div class="sw-card">
                <h2>Carousel</h2>
                <table class="form-table">
                    <tr><th>Icon display time (sec)</th><td>
                        <input type="number" name="carousel_interval" value="<?php echo esc_attr($g['carousel_interval']); ?>" min="0.5" max="10" step="0.5" class="small-text"> seconds
                        <p class="description">Default: 1.5</p>
                    </td></tr>
                    <tr><th>Transition animation</th><td>
                        <select name="animation">
                            <option value="fade"  <?php selected($g['animation'],'fade');  ?>>Fade</option>
                            <option value="slide" <?php selected($g['animation'],'slide'); ?>>Slide</option>
                        </select>
                    </td></tr>
                </table>
            </div>
            ...
            <div class="sw-card">
                <h2>Greeting bubble</h2>
                <table class="form-table">
                    <tr><th>Enable bubble</th><td><label class="sw-toggle-label">
                        <input type="checkbox" name="bubble_enabled" value="1" <?php checked($g['bubble_enabled'],1); ?>>
                        <span class="sw-toggle-switch"></span>
                        <span class="sw-toggle-text">Show text bubble next to button</span>
                    </label></td></tr>
                    <tr><th>Bubble text</th><td>
                        <input type="text" name="bubble_text" value="<?php echo esc_attr($g['bubble_text']); ?>" class="regular-text">
                    </td></tr>
                    <tr><th>Appear delay (sec)</th><td>
                        <input type="number" name="bubble_delay" value="<?php echo esc_attr($g['bubble_delay']); ?>" min="0" max="60" step="0.5" class="small-text"> seconds after page load
                    </td></tr>
                </table>
            </div>
